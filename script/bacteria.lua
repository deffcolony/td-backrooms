...
function init()
	...
	headLoop = LoadLoop("MOD/sounds/snd/hunt0.ogg", 25.0)
	turnLoop = LoadLoop("MOD/main/snd/villager/m3.ogg", 7.0)
	walkLoop = LoadLoop("robot/walk-loop.ogg", 7.0)
	walkLoop2 = LoadLoop("MOD/sounds/snd/alien.ogg", 5.0)
	rollLoop = LoadSound("MOD/sounds/snd/hunt0.ogg", 25.0)
	chargeLoop = LoadSound("MOD/sounds/snd/hunt0.ogg", 25.0)
	alertSound = LoadSound("MOD/sounds/snd/hunt0.ogg", 25.0)
	huntSound = LoadSound("MOD/sounds/snd/hunt0.ogg", 25.0)
	idleSound = LoadSound("MOD/sounds/snd/hunt0.ogg", 25.0)
	fireLoop = LoadLoop("tools/blowtorch-loop.ogg")
	disableSound = LoadSound("robot/disable0.ogg")
	crush = LoadSound("MOD/sounds/snd/bite1.ogg", 9.0)
	crush2 = LoadSound("MOD/sounds/snd/bite.ogg", 9.0)
	insound = LoadSound("MOD/main/snd/in01.ogg", 9.0)
	swing = LoadSound("MOD/main/snd/swng07.ogg", 9.0)
    fdeath = LoadSound("MOD/sounds/snd/ldeath0.ogg", 9.0)
    pain = LoadSound("MOD/sounds/snd/pain0.ogg", 9.0)
	pain2 = LoadSound("MOD/sounds/snd/bdie.ogg", 9.0)
