...
function init()
	...
	turnLoop = LoadLoop("MOD/sounds/VO/midle0.ogg", 9.0)
	walkLoop = LoadLoop("robot/walk-loop.ogg", 7.0)
	rollLoop = LoadSound("MOD/sounds/VO/midle0.ogg", 9.0)
	chargeLoop = LoadLoop("robot/charge-loop.ogg", 8.0)
	alertSound = LoadSound("MOD/sounds/VO/midle0.ogg", 9.0)
	huntSound = LoadSound("MOD/sounds/VO/midle0.ogg", 9.0)
	idleSound = LoadSound("MOD/sounds/VO/midle0.ogg", 9.0)
